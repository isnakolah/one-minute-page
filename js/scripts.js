...
$(document).ready(function () {
  function hideLanding(time1, time2) {
    $('#landing-page').fadeOut(time1);
    $('#navigation').fadeIn(time2);
  }
  ...
  $('#begin').click(function () {
    ...
    setTimeout(function () {
      ...
      if (safe === 10) {
        ...
        var wakati = confirm('Time is up, cancel to continue. Clicking OK will take you to the next step \n If you continue the results may not reflect your personality');
        if (wakati == true) {
